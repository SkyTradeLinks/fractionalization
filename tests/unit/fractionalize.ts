...
//         // .remainingAccounts(proofAccounts) // Mock value to pass the test 
//         .rpc()
//         // .instruction()
//       // await runTxnRaw(txn, fractionalizeAccounts.payer.publicKey, fractionalizationSigners, provider.connection)s
//     } catch (err) {
